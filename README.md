...
### On Visual Studio
- Download Conan Extension for Visual Studio [link](https://marketplace.visualstudio.com/items?itemName=conan-io.conan-vs-extension)
- Download the wxwidgets library from the extension
  and you are done *you can do it without the extension if it deosn't work with you*
